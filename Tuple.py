                            #TUPLE
# ORDERED COLLECTION OF ITEMS WHICH ARE iMMUTABLE (cannot be altered)
...
A tuple can have any number of items & they may be of different types (integer, float, list, string, etc.)
"""
...
$tuples indexing
a=(1,2,3,["oranges","mamngoes","banana"])
a[-1].append("avocado")
print(a[-1])
